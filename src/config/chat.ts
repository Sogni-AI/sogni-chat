...
export const CONTEXT_WINDOW_CONFIG = {
  ...
  SAFETY_MARGIN: 2_048,
  TOOL_SCHEMA_TOKENS: 5_500, // Budget for tool definitions sent to LLM. 16 tools with detailed param descriptions. Conservative estimate — previously 2,500 which was too low.
