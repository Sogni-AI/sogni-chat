      ...
      <div style={{ display: 'flex', gap: '0.5rem' }}>
        <button
          ...
          style={{
            ...
            color: expandedAction === 'refine' ? '#fff' : 'var(--color-text-primary)',
            background: expandedAction === 'refine' ? 'var(--sogni-gradient)' : 'rgba(var(--rgb-primary), 0.06)',
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 600,
            fontFamily: 'var(--font-body)',
            color: expandedAction === 'style' ? '#fff' : 'var(--color-text-primary)',
            background: expandedAction === 'style' ? 'var(--sogni-gradient)' : 'rgba(var(--rgb-primary), 0.06)',
            border: '1px solid var(--color-border)',
            borderRadius: 'var(--radius-md)',
            cursor: disabled ? 'default' : 'pointer',
            opacity: disabled ? 0.5 : 1,
