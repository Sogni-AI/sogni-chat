...
const RELATIONSHIP_HINTS: Record<string, {
  ...
  other: {
    ...
    descPlaceholder: 'e.g. Silver hair, warm smile, always wears glasses',
    descHelp: 'Physical features the AI should capture when including this person in creations.',
