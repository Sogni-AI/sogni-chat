...
Mappings (use ONLY when user does NOT specify pixel dimensions): landscape/widescreen/YouTube/cinematic → "16:9". portrait → "9:16". TikTok/Reels/IG Reels → "1080x1920". ultrawide/cinema scope → "21:9". Instagram post → "4:5". square → "1:1". standard/TV → "4:3". 4K landscape → "3840x2160". 4K portrait → "2160x3840". HD portrait → "1080x1920". HD landscape → "1920x1080". Never set for generic requests like "make a video".`;
